...
$prompt = 'Lies die Transcript-Datei "' + $TranscriptPfad + '" (Claude-Code-JSONL-Format) und schreibe eine deutsche ' + 
    'Zusammenfassung dieser Sitzung in MAXIMAL 300 Zeichen. ' +
